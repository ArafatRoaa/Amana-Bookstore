...
export const books: Book[] = [
  ...
  {
    id: '95',
    title: 'Letting Go: The Pathway to Inner Peace',
    author: 'David R. Hawkins',
    description: 'A practical guide to releasing negative emotions and achieving inner peace through the process of letting go. Explores techniques for emotional freedom and surrender to improve well-being and spiritual growth.',
    price: 18.95,
    image: '/images/book95.jpg',
    isbn: '978-1401945019',
    genre: ['Self-Help', 'Spirituality'],
    tags: ['Letting Go', 'Inner Peace', 'Emotional Healing', 'Surrender'],
